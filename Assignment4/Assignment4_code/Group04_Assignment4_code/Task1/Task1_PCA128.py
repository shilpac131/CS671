...
# # perform PCA_ dim = 128

# In[138]:


# Perform PCA dimensionality reduction to 128 dimensions
...
# Train the model
model_fit = model.fit(train_data_pca, tr_label, validation_data=(val_data_pca, val_label), epochs=10000, batch_size=32,callbacks=callback,shuffle = True)
