...
# Perform PCA dimensionality reduction to 64 dimensions
...
# Train the model
model_fit = model.fit(train_data_pca, train_label, validation_data=(val_data_pca, val_label), epochs=10000, batch_size=64,callbacks=callback,shuffle = True)
